        ...
        <section>
          ...
          <div className="space-y-2.5">
            ...
            <QuickAction
              icon={Backpack}
              label="🎒 Mi Maleta"
              sublabel="Checklist sugerido para no olvidar nada"
              onClick={() => setShowPacking(true)}
            />

            <QuickAction
              icon={Dices}
              label="🎲 Ruleta del Paseo"
              sublabel="Gamifica las tareas y castigos"
...
// ─────────────────────────────────────────────
// PACKING MODAL (Tu Maleta)
// ─────────────────────────────────────────────
function PackingModal({ paseo, onClose }) {
...
// ─────────────────────────────────────────────
// ROULETTE MODAL (Gamificación)
// ─────────────────────────────────────────────
function RouletteModal({ paseo, onClose }) {
