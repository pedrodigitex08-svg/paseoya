      ...
      <div className="px-4 space-y-5 mt-5">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <StatCard
            ...
            color="#0D9488"
            // 🔥 CORRECCIÓN: Usando la ruta real con el slug
        ...
        <section>
          ...
          >
            ...
            {/* Solo mostramos la barra de recaudo si NO es un evento corto */}
            {!isShortEvent && (
        ...
        <section>
          ...
          <div className="space-y-2.5">
            ...
            {/* Ocultamos Logística si es Bar o Restaurante */}
            {!isShortEvent && (
              <QuickAction
                icon={ShoppingBasket}
            ...
            {/* Mutación de La Vaca a La Cuenta */}
            <QuickAction
              icon={isShortEvent ? Receipt : Wallet}
          ...
          <div className="space-y-2">
            {[
              { done: !!paseo.name, label: "Evento creado", action: null },
              {
                ...
                action: `/paseo/${slug}/votar`, // 🔥 CORRECCIÓN DE RUTA
              },
              {
              ...
              },
              {
                ...
                action: `/paseo/${slug}/vaca`, // 🔥 CORRECCIÓN DE RUTA
              },
            ].map((item, i) => (
              <button
                key={i}
