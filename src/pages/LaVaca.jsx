...
// ─────────────────────────────────────────────
// COMPONENTES REUTILIZABLES (Clásicos)
// ─────────────────────────────────────────────
...
// ─────────────────────────────────────────────
// COMPONENTE PRINCIPAL (CEREBRO Y UI FINAL)
// ─────────────────────────────────────────────
export default function LaVaca() {
  ...
  // Ejecución de los dos motores separados
  ...
  // Lógica Parte-Cuentas (Cuentas Claras)
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-24 relative">
      ...
      {/* ───────────────────────────────────────────── */}
      {/* 🐄 VACA PRINCIPAL (EVENTOS COMPLETOS) */}
      {/* ───────────────────────────────────────────── */}
      {!isShortEvent && (
      ...
      {/* ───────────────────────────────────────────── */}
      {/* 🧾 DIVISIÓN DE CUENTAS (EVENTOS CORTOS / RESTAURANTE) */}
      {/* ───────────────────────────────────────────── */}
      {isShortEvent && (
        <div className="px-4 pt-5 space-y-5 animate-in fade-in duration-300">
