      ...
      {step === 2 && (
        ...
        >
          ...
          <div className="bg-white p-5 rounded-3xl shadow-sm border border-slate-100 space-y-4">
            ...
            <div>
              <label className="text-xs font-bold text-slate-400 uppercase tracking-wider ml-1 mb-0.5 block flex justify-between items-end">
                <span>{labelBudget}</span>
                {/* 🔥 LETRA PEQUEÑA ACLARATORIA AGREGADA AQUÍ */}
                {!isShortEvent && (
                  <span className="text-[9px] text-slate-300 font-normal lowercase tracking-normal">
                    (sin incluir el mercado)
                  </span>
                )}
              </label>
              <div className="flex items-center gap-3 bg-slate-50 border border-slate-200 rounded-2xl px-4 py-3 focus-within:border-green-500 focus-within:ring-2 focus-within:ring-green-100 transition-all mt-1.5">
